...
type Endpoint16_0Request = Parameters<RawClient["server.graphify"]["session.graphify.suggestion"]>[0]
type Endpoint16_0Input = { readonly sessionID: Endpoint16_0Request["params"]["sessionID"] }
const Endpoint16_0 = (raw: RawClient["server.graphify"]) => (input: Endpoint16_0Input) =>
  raw["session.graphify.suggestion"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint16_1Request = Parameters<RawClient["server.graphify"]["session.graphify.map"]>[0]
type Endpoint16_1Input = { readonly sessionID: Endpoint16_1Request["params"]["sessionID"] }
const Endpoint16_1 = (raw: RawClient["server.graphify"]) => (input: Endpoint16_1Input) =>
  raw["session.graphify.map"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint16_2Request = Parameters<RawClient["server.graphify"]["session.graphify.map.get"]>[0]
type Endpoint16_2Input = {
  readonly sessionID: Endpoint16_2Request["params"]["sessionID"]
  readonly jobID: Endpoint16_2Request["params"]["jobID"]
}
const Endpoint16_2 = (raw: RawClient["server.graphify"]) => (input: Endpoint16_2Input) =>
  raw["session.graphify.map.get"]({ params: { sessionID: input["sessionID"], jobID: input["jobID"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const adaptGroup16 = (raw: RawClient["server.graphify"]) => ({
  suggestion: Endpoint16_0(raw),
  map: Endpoint16_1(raw),
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.graphify": adaptGroup16(raw["server.graphify"]),
