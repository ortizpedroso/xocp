export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP kunde inte läsas in",
  "desktop.recovery.terminated": "XOCP-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "XOCP svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av XOCP misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i XOCP.",
  ...
  "dialog.server.description": "Växla vilken XOCP-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar XOCP i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar XOCP i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera XOCP i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera XOCP i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan XOCP kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "XOCP kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan XOCP igen.",
  ...
  "help.tabs.introduction": "XOCP Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av XOCP ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till XOCP-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, XOCP stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "XOCP innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör XOCP-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för XOCP",
  ...
  "settings.general.row.appearance.description": "Anpassa hur XOCP ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om XOCP följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa XOCPs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när XOCP startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av XOCP.",
