export const dict = {
  ...
  "desktop.menu.documentation": "Documentație XOCP",
  ...
  "desktop.menu.ariaLabel": "Meniu XOCP",
  ...
  "desktop.recovery.loadFailed": "XOCP nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra XOCP s-a închis neașteptat",
  "desktop.recovery.unresponsive": "XOCP nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea XOCP a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea XOCP s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în XOCP.",
  ...
  "dialog.server.description": "Schimbă serverul XOCP la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică XOCP în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează XOCP în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează XOCP în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează XOCP în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca XOCP să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "XOCP nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune XOCP ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei XOCP",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, XOCP nu suportă încă autentificarea MCP.',
  ...
  "settings.desktop.wsl.description": "Rulează serverul XOCP în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru XOCP",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul XOCP pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă XOCP urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema XOCP.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea XOCP",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune XOCP.",
