...
export const dict = {
  ...
  "desktop.menu.documentation": "XOCP-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "XOCP-meny",
  ...
  "desktop.recovery.loadFailed": "XOCP kunne ikke lastes inn",
  "desktop.recovery.terminated": "XOCP-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "XOCP svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av XOCP mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av XOCP er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i XOCP.",
  ...
  "dialog.server.description": "Bytt hvilken XOCP-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av XOCP ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til XOCP-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at XOCP ikke støtter MCP-autentisering ennå.',
  ...
  "settings.desktop.wsl.description": "Kjør XOCP-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for XOCP",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan XOCP ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om XOCP skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i XOCP.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når XOCP starter",
  ...
  "settings.updates.toast.latest.title": "XOCP er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av XOCP.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker XOCP i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer XOCP i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater XOCP i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer XOCP i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før XOCP kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "XOCP kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter XOCP på nytt.",
  ...
  "help.tabs.introduction": "XOCP Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
  ...
  "session.graphify.suggestion.message": "Denne sesjonen ser ut til å være klar for et prosjektkart.",
  "session.graphify.map.action": "Kartlegg prosjekt",
  "session.graphify.map.loading": "Kartlegger…",
  "session.graphify.error.disabled": "Graphify-kartlegging er deaktivert.",
  "session.graphify.error.uvNotFound":
    "Graphify er ikke tilgjengelig på denne maskinen. Installer uv: https://docs.astral.sh/uv/",
  "session.graphify.error.updateFailed": "Oppdatering av Graphify-kartet mislyktes.",
  "session.graphify.toast.ready": "Prosjektkart klart",
