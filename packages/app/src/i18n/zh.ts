...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP 加载失败",
  "desktop.recovery.terminated": "XOCP 窗口意外终止",
  "desktop.recovery.unresponsive": "XOCP 未响应",
  ...
  "desktop.wsl.error.installOpencode": "XOCP 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 XOCP",
  "desktop.wsl.error.updateVersion":
    "XOCP 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 XOCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 XOCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 XOCP 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 XOCP 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 XOCP...",
  "wsl.onboarding.updatingOpencode": "正在更新 XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 XOCP...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 XOCP。",
  "wsl.onboarding.updateOpencode": "更新 XOCP",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 XOCP 已就绪。",
  "wsl.onboarding.opencodeReady": "XOCP 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 XOCP。",
  "wsl.onboarding.installOpencode": "安装 XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 XOCP",
  ...
  "wsl.onboarding.wslNotInstalled.description": "XOCP 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "XOCP 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 XOCP。",
  ...
  "help.tabs.introduction": "XOCP Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 XOCP 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：XOCP 暂不支持 MCP 认证。',
  ...
  "session.graphify.suggestion.message": "此会话已适合生成项目结构图。",
  "session.graphify.map.action": "生成项目图",
  "session.graphify.map.loading": "正在生成…",
  "session.graphify.error.disabled": "Graphify 项目映射已禁用。",
  "session.graphify.error.uvNotFound": "此设备上无法使用 Graphify。请安装 uv：https://docs.astral.sh/uv/",
  "session.graphify.error.updateFailed": "Graphify 项目图更新失败。",
  "session.graphify.toast.ready": "项目图已就绪",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 XOCP 服务器。",
  ...
  "settings.general.row.language.description": "更改 XOCP 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 XOCP 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 XOCP 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 XOCP 的主题。",
  ...
  "settings.updates.row.startup.description": "在 XOCP 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 XOCP。",
