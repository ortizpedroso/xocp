export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni XOCP",
  ...
  "desktop.menu.ariaLabel": "Menuja XOCP",
  ...
  "desktop.recovery.loadFailed": "XOCP nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja XOCP u mbyll papritur",
  "desktop.recovery.unresponsive": "XOCP nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i XOCP dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i XOCP përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në XOCP.",
  ...
  "dialog.server.description": "Ndrysho me cilin server XOCP lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon XOCP në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "XOCP po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson XOCP në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso XOCP në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni XOCP në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se XOCP të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "XOCP nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i XOCP ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i XOCP",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, XOCP nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin XOCP brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për XOCP",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket XOCP në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse XOCP ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e XOCP.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset XOCP",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të XOCP.",
