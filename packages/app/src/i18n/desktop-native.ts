...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "XOCP failed to load",
  "desktop.recovery.terminated": "XOCP window terminated unexpectedly",
  "desktop.recovery.unresponsive": "XOCP is not responding",
  ...
  "desktop.wsl.error.installOpencode": "XOCP installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
