export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za XOCP",
  ...
  "desktop.recovery.loadFailed": "XOCP se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor XOCP-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "XOCP ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija XOCP-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje XOCP-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u XOCP-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u XOCP-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u XOCP-u.",
  ...
  "dialog.server.description": "Promijeni na koji se XOCP server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera XOCP u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje XOCP u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj XOCP u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj XOCP u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi XOCP mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "XOCP nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija XOCP-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku XOCP timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: XOCP još ne podržava MCP autentifikaciju.',
  ...
  "settings.desktop.wsl.description": "Pokreni XOCP server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u XOCP-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako XOCP izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li XOCP prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu XOCP-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se XOCP pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju XOCP-a.",
