export const dict = {
  ...
  "desktop.menu.documentation": "XOCP دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "XOCP لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "XOCP دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "XOCP جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "XOCP دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ XOCP انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "XOCP دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے XOCP وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے XOCP وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے XOCP وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس XOCP سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ XOCP دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "XOCP نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ XOCP نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ XOCP نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "XOCP اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "XOCP {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "XOCP تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ XOCP انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "XOCP انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "XOCP دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "XOCP ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر XOCP دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "XOCP Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع XOCP ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، XOCP ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر XOCP سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "XOCP لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے XOCP کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا XOCP سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "XOCP نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں XOCP لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی XOCP دا تازہ ترین ورژن چلا رئے او۔",
