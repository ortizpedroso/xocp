export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi XOCP",
  ...
  "desktop.recovery.loadFailed": "XOCP gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap XOCP ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "XOCP tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan XOCP gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini XOCP selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam XOCP.",
  ...
  "dialog.server.description": "Tukar pelayan XOCP yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak XOCP dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini XOCP dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini XOCP dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang XOCP dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum XOCP boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "XOCP tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu XOCP ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan XOCP",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, XOCP belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan XOCP dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk XOCP",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa XOCP pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada XOCP mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema XOCP.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila XOCP dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini XOCP.",
