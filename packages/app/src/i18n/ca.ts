export const dict = {
  ...
  "desktop.menu.documentation": "XOCP Documentació",
  ...
  "desktop.menu.ariaLabel": "menú XOCP.",
  ...
  "desktop.recovery.loadFailed": "XOCP no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra XOCP s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "XOCP no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de XOCP ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a XOCP.",
  ...
  "dialog.server.description": "Canvia a quin XOCP servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant XOCP a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant XOCP a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza XOCP a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu XOCP a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que XOCP pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "XOCP no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir XOCP.",
  ...
  "help.tabs.introduction": "XOCP L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de XOCP ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip XOCP.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que XOCP encara no admet l\'autenticació MCP.',
  ...
  "app.name.desktop": "XOCP Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor XOCP dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a XOCP",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu XOCP al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si XOCP segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de XOCP.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï XOCP.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de XOCP.",
