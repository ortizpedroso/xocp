export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu XOCP",
  ...
  "desktop.recovery.loadFailed": "Không tải được XOCP",
  "desktop.recovery.terminated": "Cửa sổ XOCP đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "XOCP không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật XOCP nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong XOCP.",
  ...
  "dialog.server.description": "Chuyển máy chủ XOCP mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra XOCP trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật XOCP trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật XOCP trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt XOCP trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi XOCP có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "XOCP không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của XOCP ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm XOCP",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: XOCP chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ XOCP bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho XOCP",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của XOCP trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem XOCP tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của XOCP.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi XOCP khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của XOCP.",
