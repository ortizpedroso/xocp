export const dict = {
  ...
  "desktop.menu.documentation": "XOCP Skjøl",
  ...
  "desktop.menu.ariaLabel": "XOCP valmynd",
  ...
  "desktop.recovery.loadFailed": "XOCP miseydnaðist at heinta",
  "desktop.recovery.terminated": "XOCP vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "XOCP svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "XOCP uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í XOCP.",
  ...
  "dialog.server.description": "Skift hvønn XOCP ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna XOCP í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring XOCP í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør XOCP í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set XOCP upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn XOCP kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "XOCP kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani XOCP aftur.",
  ...
  "help.tabs.introduction": "XOCP Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av XOCP ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til XOCP toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, XOCP stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "XOCP inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "XOCP Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr XOCP ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri XOCP",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu XOCP sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um XOCP fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu XOCP er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá XOCP byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av XOCP.",
