export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja XOCPssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja XOCPssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja XOCPssa.",
  ...
  "dialog.server.description": "Vaihda XOCP-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan XOCPa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan XOCPa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään XOCPa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään XOCPa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä XOCP jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna XOCP jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCPa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin XOCP voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "XOCP ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten XOCP uudelleen.",
  ...
  "toast.update.description": "XOCPn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä XOCP-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että XOCP ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "XOCP sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita XOCP-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda XOCPn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä XOCP näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö XOCP järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta XOCPn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun XOCP käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät XOCPn uusinta versiota.",
  ...
  "desktop.menu.documentation": "XOCP-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "XOCP-valikko",
  ...
  "desktop.recovery.loadFailed": "XOCPn lataaminen epäonnistui",
  "desktop.recovery.terminated": "XOCP-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "XOCP ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "XOCPn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCPa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCPn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "XOCP Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
