...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP yüklenemedi",
  "desktop.recovery.terminated": "XOCP penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "XOCP yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "XOCP kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "XOCP güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve XOCP'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak XOCP'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak XOCP'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi XOCP sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde XOCP kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "XOCP güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde XOCP güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki XOCP'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "XOCP'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde XOCP hazır.",
  "wsl.onboarding.opencodeReady": "XOCP hazır.",
  "wsl.onboarding.installOpencodeIn": "XOCP'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "XOCP'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "XOCP'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "XOCP bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından XOCP'u tekrar açın.",
  ...
  "help.tabs.introduction": "XOCP Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı XOCP ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: XOCP henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "session.graphify.suggestion.message": "Bu oturum bir proje haritası için hazır görünüyor.",
  "session.graphify.map.action": "Projeyi haritala",
  "session.graphify.map.loading": "Haritalanıyor…",
  "session.graphify.error.disabled": "Graphify haritalaması devre dışı.",
  "session.graphify.error.uvNotFound": "Graphify bu bilgisayarda kullanılamıyor. uv kurun: https://docs.astral.sh/uv/",
  "session.graphify.error.updateFailed": "Graphify harita güncellemesi başarısız oldu.",
  "session.graphify.toast.ready": "Proje haritası hazır",
  ...
  "app.name.desktop": "XOCP Masaüstü",
  ...
  "settings.desktop.wsl.description": "XOCP sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "XOCP'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "XOCP'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "XOCP'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "XOCP'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "XOCP başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "XOCP'un en son sürümünü kullanıyorsunuz.",
