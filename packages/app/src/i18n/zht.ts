...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP 載入失敗",
  "desktop.recovery.terminated": "XOCP 視窗意外終止",
  "desktop.recovery.unresponsive": "XOCP 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "XOCP 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 XOCP",
  "desktop.wsl.error.updateVersion":
    "XOCP 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 XOCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 XOCP 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 XOCP 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 XOCP 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 XOCP...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 XOCP 已就緒。",
  "wsl.onboarding.opencodeReady": "XOCP 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 XOCP。",
  "wsl.onboarding.installOpencode": "安裝 XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 XOCP",
  ...
  "wsl.onboarding.wslUnavailable.description": "XOCP 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 XOCP。",
  ...
  "help.tabs.introduction": "XOCP Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 XOCP 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：XOCP 尚不支援 MCP 驗證。",
  ...
  "session.graphify.suggestion.message": "此工作階段已適合產生專案結構圖。",
  "session.graphify.map.action": "產生專案圖",
  "session.graphify.map.loading": "正在產生…",
  "session.graphify.error.disabled": "Graphify 專案對應已停用。",
  "session.graphify.error.uvNotFound": "此裝置上無法使用 Graphify。請安裝 uv：https://docs.astral.sh/uv/",
  "session.graphify.error.updateFailed": "Graphify 專案圖更新失敗。",
  "session.graphify.toast.ready": "專案圖已就緒",
  ...
  "sidebar.gettingStarted.line1": "XOCP 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 XOCP 伺服器。",
  ...
  "settings.general.row.language.description": "變更 XOCP 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 XOCP 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 XOCP 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 XOCP 的主題。",
  ...
  "settings.updates.row.startup.description": "在 XOCP 啟動時自動檢查更新",
