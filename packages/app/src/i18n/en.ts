...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in XOCP.",
  ...
  "dialog.server.description": "Switch which XOCP server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Checking XOCP in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Updating XOCP in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update XOCP in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP is ready.",
  "wsl.onboarding.installOpencodeIn": "Install XOCP in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before XOCP can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "XOCP could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of XOCP ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the XOCP team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, XOCP does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "XOCP includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the XOCP server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for XOCP",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how XOCP looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether XOCP follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how XOCP is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when XOCP launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of XOCP.",
