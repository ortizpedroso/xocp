export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de XOCP",
  ...
  "desktop.menu.ariaLabel": "Menú de XOCP",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar XOCP",
  "desktop.recovery.terminated": "La ventana de XOCP se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "XOCP no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de XOCP finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en XOCP.",
  ...
  "dialog.server.description": "Cambiar el servidor de XOCP al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando XOCP en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando XOCP en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza XOCP en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala XOCP en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que XOCP pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "XOCP no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de XOCP ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de XOCP",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: XOCP aún no admite la autenticación MCP.',
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor XOCP dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para XOCP",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve XOCP en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si XOCP sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de XOCP.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia XOCP",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de XOCP.",
