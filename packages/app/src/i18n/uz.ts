export const dict = {
  ...
  "desktop.menu.documentation": "XOCP hujjatlari",
  ...
  "desktop.menu.ariaLabel": "XOCP menyusi",
  ...
  "desktop.recovery.loadFailed": "XOCP yuklanmadi",
  "desktop.recovery.terminated": "XOCP oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "XOCP javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "XOCP oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "XOCP yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va XOCP’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va XOCP da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va XOCP da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi XOCP serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "XOCP {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "XOCP yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "XOCP {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "XOCP-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "XOCP-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "XOCP {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "XOCP tayyor.",
  "wsl.onboarding.installOpencodeIn": "XOCP-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "XOCP-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "XOCP WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "XOCP WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra XOCP-ni qayta oching.",
  ...
  "help.tabs.introduction": "XOCP Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida XOCP jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, XOCP hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "XOCP bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi XOCP serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "XOCP uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "XOCP qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "XOCP tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "XOCP mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "XOCP ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz XOCP oxirgi versiyasini ishga tushiryapsiz.",
