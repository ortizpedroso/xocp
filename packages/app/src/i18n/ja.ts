export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCPを読み込めませんでした",
  "desktop.recovery.terminated": "XOCPのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "XOCPが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "XOCPのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはXOCPがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "XOCPのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、XOCPで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してXOCPで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、XOCPで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するXOCPサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "XOCPを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のXOCPを確認中...",
  "wsl.onboarding.updatingOpencode": "XOCPを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のXOCPを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のXOCPを更新してください。",
  "wsl.onboarding.updateOpencode": "XOCPを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のXOCPの準備ができました。",
  "wsl.onboarding.opencodeReady": "XOCPの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にXOCPをインストールしてください。",
  "wsl.onboarding.installOpencode": "XOCPをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCPがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "XOCPでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、XOCPをもう一度開いてください。",
  ...
  "help.tabs.introduction": "XOCP Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCPの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをXOCPチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: XOCPはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "XOCPには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でXOCPサーバーを実行します。",
  ...
  "settings.general.row.language.description": "XOCPの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのXOCPの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "XOCPがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "XOCPのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "XOCP の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "XOCP は最新バージョンです。",
