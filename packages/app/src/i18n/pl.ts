export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja XOCP",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać XOCP",
  "desktop.recovery.terminated": "Okno XOCP zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "XOCP nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja XOCP została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w XOCP.",
  ...
  "dialog.server.description": "Przełącz serwer XOCP, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie XOCP w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie XOCP w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj XOCP w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj XOCP w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim XOCP będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "XOCP nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja XOCP ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu XOCP",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: XOCP nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "XOCP zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer XOCP wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla XOCP",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd XOCP na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy XOCP ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw XOCP.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania XOCP",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji XOCP.",
