export const dict = {
  ...
  "desktop.menu.documentation": "XOCP-documentatie",
  ...
  "desktop.recovery.loadFailed": "XOCP kan niet worden geladen",
  "desktop.recovery.terminated": "Het XOCP-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "XOCP reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van XOCP is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De XOCP-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in XOCP te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in XOCP te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in XOCP te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke XOCP-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP controleren...",
  "wsl.onboarding.checkingOpencodeIn": "XOCP controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "XOCP bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "XOCP bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk XOCP bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "XOCP bijwerken",
  "wsl.onboarding.opencodeReadyIn": "XOCP is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer XOCP in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat XOCP een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "XOCP kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens XOCP opnieuw.",
  ...
  "help.tabs.introduction": "XOCP Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van XOCP ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het XOCP-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: XOCP ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "XOCP bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de XOCP-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor XOCP",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe XOCP eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of XOCP het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van XOCP aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer XOCP wordt gestart",
  ...
  "settings.updates.toast.latest.title": "XOCP is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van XOCP.",
