export const dict = {
  ...
  "desktop.menu.documentation": "XOCP Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "XOCP meni",
  ...
  "desktop.recovery.loadFailed": "XOCP ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno XOCP se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "XOCP se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev XOCP ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev XOCP je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v XOCP.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom XOCP se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje XOCP ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje XOCP v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje XOCP ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje XOCP v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite XOCP v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite XOCP v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko XOCP doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "XOCP ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica XOCP ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi XOCP",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, XOCP še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik XOCP znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za XOCP",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako XOCP izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali XOCP sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo XOCP.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene XOCP",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico XOCP.",
