...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "XOCP se nije uspio učitati",
  "Prozor aplikacije XOCP neočekivano je zatvoren",
  "XOCP ne reagira",
  ...
  "Instalacija aplikacije XOCP nije uspjela",
  ...
  "XOCP nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije XOCP je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u XOCP.",
  ...
  "dialog.server.description": "Promijenite na koji se XOCP poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera XOCP u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje XOCP u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte XOCP u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte XOCP u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte XOCP",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što XOCP može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "XOCP nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite XOCP.",
  ...
  "help.tabs.introduction": "Radna površina XOCP sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija XOCP ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku XOCP timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, XOCP još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "XOCP uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "XOCP Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite XOCP poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za XOCP",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako XOCP izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li XOCP slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je XOCP tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se XOCP pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju XOCP.",
