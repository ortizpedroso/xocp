...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in XOCP zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in XOCP zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in XOCP zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den XOCP-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "XOCP",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "XOCP in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "XOCP wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "XOCP in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie XOCP in {{distro}}.",
  "wsl.onboarding.updateOpencode": "XOCP aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "XOCP ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "XOCP ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie XOCP in {{distro}}.",
  "wsl.onboarding.installOpencode": "XOCP installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor XOCP einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "XOCP konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann XOCP erneut.",
  ...
  "toast.update.description": "Eine neue Version von XOCP ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem XOCP-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: XOCP unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "XOCP mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "session.graphify.suggestion.message": "Diese Sitzung scheint bereit für eine Projektübersicht zu sein.",
  "session.graphify.map.action": "Projekt kartieren",
  "session.graphify.map.loading": "Kartierung läuft…",
  "session.graphify.error.disabled": "Graphify-Kartierung ist deaktiviert.",
  "session.graphify.error.uvNotFound":
    "Graphify ist auf diesem Computer nicht verfügbar. Installieren Sie uv: https://docs.astral.sh/uv/",
  "session.graphify.error.updateFailed": "Aktualisierung der Graphify-Karte fehlgeschlagen.",
  "session.graphify.toast.ready": "Projektübersicht bereit",
  ...
  "sidebar.gettingStarted.line1": "XOCP enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "XOCP-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für XOCP ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie XOCP auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob XOCP dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von XOCP anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von XOCP automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "XOCP ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von XOCP wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "XOCP konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das XOCP-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "XOCP reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "XOCP-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das XOCP-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "XOCP Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
  ...
  "session.elicitador.ambiguity.message": "This looks like it might describe a new system — should I run this as a formal project (with a specification document), or is it just a quick question?",
  ...
  "settings.general.row.enableGraphify.description": "Map code structure (calls, imports, dependencies) on demand. Requires `uv` installed on the machine.",
  "settings.providers.omniroute.activate.action": "Activate OmniRoute",
  "settings.providers.omniroute.activate.loading": "Activating...",
  "settings.providers.omniroute.activate.downloading": "Downloading...",
  "settings.providers.omniroute.activate.configuring": "Configuring...",
  "settings.providers.omniroute.activate.ready": "OmniRoute is ready",
  "settings.providers.omniroute.activate.error.npm": "npm/npx is not available on this machine.",
  "settings.providers.omniroute.activate.error.empty": "OmniRoute activation finished without output.",
  "settings.providers.omniroute.activate.error.failed": "OmniRoute activation failed",
  "settings.providers.omniroute.activate.error.timeout": "OmniRoute activation timed out. Try again in a moment.",
  "settings.providers.headroom.title": "Connect Headroom",
  "settings.providers.headroom.description": "Local LLM proxy with context compression (default port 8787).",
  "settings.providers.headroom.activate.action": "Activate Headroom",
  "settings.providers.headroom.activate.loading": "Activating...",
  "settings.providers.headroom.activate.installing": "Installing...",
  "settings.providers.headroom.activate.starting": "Starting proxy...",
  "settings.providers.headroom.activate.ready": "Headroom is ready",
  "settings.providers.headroom.activate.error.uv": "uv is not available on this machine.",
  "settings.providers.headroom.activate.error.empty": "Headroom activation finished without output.",
  "settings.providers.headroom.activate.error.failed": "Headroom activation failed",
  "settings.providers.headroom.activate.error.timeout": "Headroom activation timed out. Try again in a moment.",
