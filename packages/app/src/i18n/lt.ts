...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "XOCP įkelti nepavyko",
  "XOCP langas netikėtai užsidarė",
  "XOCP neatsako",
  ...
  "XOCP įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "XOCP neįdiegtas distributyve {{distro}}",
  "XOCP naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius XOCP.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio XOCP serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama XOCP {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas XOCP {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite XOCP {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite XOCP į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad XOCP galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "XOCP nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują XOCP ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą XOCP komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad XOCP dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "XOCP apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "XOCP darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite XOCP serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite XOCP ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip XOCP atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar XOCP seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite XOCP temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas XOCP",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią XOCP versiją.",
