export const dict = {
  ...
  "desktop.menu.documentation": "XOCP Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka XOCP",
  ...
  "desktop.recovery.loadFailed": "XOCP se nepodařilo načíst",
  "desktop.recovery.terminated": "XOCP okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "XOCP nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "XOCP instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v XOCP.",
  ...
  "dialog.server.description": "Přepněte, ke kterému XOCP serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola XOCP v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace XOCP v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace XOCP v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte XOCP do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než XOCP může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "XOCP nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete XOCP.",
  ...
  "help.tabs.introduction": "XOCP Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze XOCP ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu XOCP",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: XOCP zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server XOCP uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro XOCP",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled XOCP na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude XOCP následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma XOCP.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění XOCP",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi XOCP.",
