export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP laadimine ebaõnnestus",
  "desktop.recovery.terminated": "XOCP aken suleti ootamatult",
  "desktop.recovery.unresponsive": "XOCP ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "XOCP installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "XOCP värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid XOCP'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises XOCP.",
  ...
  "dialog.server.description": "Lülitage, millise XOCP serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "XOCP kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "XOCP värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "XOCP värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda XOCP jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige XOCP asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui XOCP saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "XOCP ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti XOCP.",
  ...
  "help.tabs.introduction": "XOCP Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse XOCP ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast XOCP meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, XOCP ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "XOCP sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage XOCP server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke XOCP kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas XOCP teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas XOCP järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas XOCP on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui XOCP käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse XOCP uusimat versiooni.",
