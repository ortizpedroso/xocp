...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða XOCP",
  "XOCP-glugganum var óvænt lokað",
  "XOCP svarar ekki",
  ...
  "XOCP er ekki uppsett í {{distro}}",
  "Uppfærslu XOCP lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í XOCP.",
  ...
  "dialog.server.description": "Skiptu um hvaða XOCP miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar XOCP í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir XOCP í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu XOCP í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp XOCP í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en XOCP getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "XOCP gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan XOCP aftur.",
  ...
  "help.tabs.introduction": "XOCP Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af XOCP ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til XOCP teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, XOCP styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "XOCP inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "XOCP skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu XOCP netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir XOCP",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig XOCP lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort XOCP fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig XOCP er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar XOCP ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af XOCP.",
