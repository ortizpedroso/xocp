export const dict = {
  ...
  "desktop.menu.documentation": "XOCP دستاویزات",
  ...
  "desktop.menu.ariaLabel": "XOCP مینو",
  ...
  "desktop.recovery.loadFailed": "XOCP لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "XOCP ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "XOCP جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "XOCP کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں XOCP انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "XOCP کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور XOCP میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور XOCP میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور XOCP میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس XOCP سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں XOCP چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "XOCP کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں XOCP کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں XOCP کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "XOCP کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "XOCP {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "XOCP تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں XOCP انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "XOCP انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ XOCP WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "XOCP اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر XOCP کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "XOCP Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم XOCP ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، XOCP ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "XOCP میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "XOCP ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر XOCP سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "XOCP کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر XOCP کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا XOCP سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "XOCP کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "XOCP لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ XOCP کا تازہ ترین ورژن چلا رہے ہیں۔",
