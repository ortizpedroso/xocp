export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP yüklənə bilmədi",
  "desktop.recovery.terminated": "XOCP pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "XOCP cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "XOCP quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "XOCP yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və XOCP-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və XOCP-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və XOCP-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu XOCP serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "XOCP yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də XOCP yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "XOCP yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də XOCP yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də XOCP-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "XOCP-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "XOCP {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "XOCP hazırdır.",
  "wsl.onboarding.installOpencodeIn": "XOCP-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "XOCP quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "XOCP WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "XOCP bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra XOCP-u yenidən açın.",
  ...
  "help.tabs.introduction": "XOCP Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "XOCP-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı XOCP komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: XOCP hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "XOCP-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində XOCP serverini işlət.",
  ...
  "settings.general.row.language.description": "XOCP üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "XOCP-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "XOCP-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "XOCP-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "XOCP açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "XOCP-un ən son versiyasından istifadə edirsiniz.",
