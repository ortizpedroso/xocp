export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in XOCP.",
  ...
  "dialog.server.description": "Cambia il server XOCP a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo XOCP in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento XOCP in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna XOCP in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa XOCP in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che XOCP possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "XOCP non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di XOCP ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team XOCP",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: XOCP non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server XOCP all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per XOCP",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di XOCP sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se XOCP segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di XOCP.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di XOCP",
  ...
  "settings.updates.toast.latest.title": "XOCP è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di XOCP.",
  ...
  "desktop.menu.documentation": "Documentazione di XOCP",
  ...
  "desktop.menu.ariaLabel": "Menu XOCP",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare XOCP",
  "desktop.recovery.terminated": "La finestra di XOCP si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "XOCP non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di XOCP non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di XOCP è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
