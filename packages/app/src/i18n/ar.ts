export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل XOCP",
  "desktop.recovery.terminated": "توقفت نافذة XOCP بشكل غير متوقع",
  "desktop.recovery.unresponsive": "XOCP لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث XOCP، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في XOCP.",
  ...
  "dialog.server.description": "تبديل خادم XOCP الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من XOCP في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث XOCP في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث XOCP في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت XOCP في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن XOCP من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على XOCP التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح XOCP.",
  ...
  "help.tabs.introduction": "أصبح XOCP Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من XOCP ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق XOCP",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن XOCP لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن XOCP نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم XOCP داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ XOCP",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور XOCP على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان XOCP يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة XOCP.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل XOCP",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من XOCP.",
