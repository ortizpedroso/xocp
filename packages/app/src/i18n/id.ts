export const dict = {
  ...
  "desktop.recovery.loadFailed": "XOCP gagal dimuat",
  "desktop.recovery.terminated": "Jendela XOCP berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "XOCP tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi XOCP gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan XOCP selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di XOCP.",
  ...
  "dialog.server.description": "Ganti server XOCP mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa XOCP di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui XOCP di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui XOCP di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP siap.",
  "wsl.onboarding.installOpencodeIn": "Instal XOCP di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum XOCP dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "XOCP tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru XOCP ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim XOCP",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: XOCP belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "XOCP menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server XOCP di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk XOCP",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan XOCP di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah XOCP mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat XOCP diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru XOCP.",
