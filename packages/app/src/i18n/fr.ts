export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'XOCP",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'XOCP",
  "desktop.recovery.terminated": "La fenêtre XOCP s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "XOCP ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'XOCP est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans XOCP.",
  ...
  "dialog.server.description": "Changez le serveur XOCP auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'XOCP dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'XOCP dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour XOCP dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour XOCP",
  "wsl.onboarding.opencodeReadyIn": "XOCP est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "XOCP est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez XOCP dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'XOCP puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "XOCP n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez XOCP.",
  ...
  "help.tabs.introduction": "XOCP Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'XOCP ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe XOCP",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'XOCP ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "XOCP inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur XOCP dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour XOCP",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'XOCP sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si XOCP suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'XOCP.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'XOCP",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'XOCP.",
