export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i XOCP.",
  ...
  "dialog.server.description": "Skift hvilken XOCP-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker XOCP i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer XOCP i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater XOCP i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før XOCP kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "XOCP kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter XOCP igen.",
  ...
  "toast.update.description": "En ny version af XOCP ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til XOCP-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, XOCP understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "XOCP inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør XOCP-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for XOCP",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan XOCP ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om XOCP skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas XOCPs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når XOCP starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af XOCP.",
  ...
  "desktop.recovery.loadFailed": "XOCP kunne ikke indlæses",
  "desktop.recovery.terminated": "XOCP-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af XOCP mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "XOCP er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af XOCP er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "XOCP Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
