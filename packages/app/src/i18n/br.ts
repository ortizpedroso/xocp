export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do XOCP",
  ...
  "desktop.menu.ariaLabel": "Menu do XOCP",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o XOCP",
  "desktop.recovery.terminated": "A janela do XOCP foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O XOCP não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do XOCP",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O XOCP não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do XOCP foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no XOCP.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no XOCP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no XOCP.",
  ...
  "dialog.server.description": "Trocar para qual servidor XOCP este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o XOCP...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o XOCP em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o XOCP...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o XOCP em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o XOCP em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o XOCP",
  "wsl.onboarding.opencodeReadyIn": "O XOCP está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O XOCP está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o XOCP em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o XOCP",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "XOCP não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o XOCP possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O XOCP não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o XOCP novamente.",
  ...
  "help.tabs.introduction": "Agora, o XOCP Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do XOCP ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do XOCP",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: XOCP ainda não suporta autenticação MCP.',
  ...
  "home.sessions.tree.hint": "Expanda um projeto à esquerda para ver as sessões por seção.",
  "home.providerTip":
  ...
  "sidebar.gettingStarted.line1": "XOCP inclui modelos gratuitos para você começar imediatamente.",
  ...
  "sidebar.project.expand": "Expandir seções do projeto",
  "sidebar.project.collapse": "Recolher seções do projeto",
  ...
  "settings.desktop.wsl.description": "Executar o servidor XOCP dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do XOCP",
  ...
  "settings.general.row.appearance.description": "Personalize como o XOCP aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o XOCP segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o XOCP é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o XOCP iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do XOCP.",
