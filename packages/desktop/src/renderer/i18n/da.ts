export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af XOCP er blevet downloadet. Vil du installere den og genstarte?",
