export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de XOCP. ¿Quieres instalarla y reiniciar?",
