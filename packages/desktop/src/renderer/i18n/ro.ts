export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} XOCP a fost descărcată. Vrei să o instalezi și să repornești?",
