export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} XOCP telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
