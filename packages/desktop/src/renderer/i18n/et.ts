export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse XOCP uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "XOCP'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
