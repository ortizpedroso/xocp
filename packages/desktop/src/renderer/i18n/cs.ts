export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace XOCP. Chcete ji nainstalovat a aplikaci znovu spustit?",
