export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko XOCP versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "XOCP versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
