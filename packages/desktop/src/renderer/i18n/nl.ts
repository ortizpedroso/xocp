export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van XOCP is gedownload. Wil je deze installeren en XOCP opnieuw starten?",
