export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di XOCP è stata scaricata. Vuoi installarla e riavviare l'app?",
