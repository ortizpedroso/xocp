export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von XOCP wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
