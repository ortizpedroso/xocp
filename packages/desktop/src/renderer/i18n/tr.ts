export const dict = {
  ...
  "desktop.updater.none.message": "XOCP'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "XOCP'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
