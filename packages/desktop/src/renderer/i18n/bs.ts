export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju XOCP-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} XOCP-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
