export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av XOCP er lastet ned. Vil du installere den og starte på nytt?",
