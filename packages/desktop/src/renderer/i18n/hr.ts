export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije XOCP. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
