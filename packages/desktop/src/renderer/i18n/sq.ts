export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i XOCP është shkarkuar, dëshironi ta instaloni dhe rinisni?",
