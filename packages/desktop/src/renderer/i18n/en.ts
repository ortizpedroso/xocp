export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of XOCP has been downloaded, would you like to install it and relaunch?",
