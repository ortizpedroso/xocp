export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon XOCP ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "XOCPning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
