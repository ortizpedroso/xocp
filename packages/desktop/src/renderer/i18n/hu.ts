export const dict = {
  ...
  "desktop.updater.none.message": "Már az XOCP legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az XOCP {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
