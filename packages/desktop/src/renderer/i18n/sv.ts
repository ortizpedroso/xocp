export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av XOCP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av XOCP har laddats ned. Vill du installera den och starta om programmet?",
