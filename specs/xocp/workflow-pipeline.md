...
| S2 | **≥3 critérios de aceite independentes** | A tarefa, como descrita, já implica ≥3 critérios que podem ser verificados **sem depender um do outro**? Se um critério só faz sentido depois de outro passar, não conta como independente. |
...
- S2 (≥3 critérios de aceite independentes, sem depender um do outro)
